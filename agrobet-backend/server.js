...
// --- ROTAS DO PAINEL DE ADMINISTRAÇÃO (COM CORREÇÕES) ---
...
app.get('/admin/games', authAdmin, async (req, res) => {
    try {
        ...
        const gameRows = games.map(game => {
            // VERIFICAÇÃO DE SEGURANÇA: Garante que os dados existem antes de os usar
            if (!game || !game.home || !game.away) return ''; // Ignora jogos com dados corrompidos
